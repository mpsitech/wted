...
#ifndef CTRWTEDZUDKMEMWRTRACK_H
#define CTRWTEDZUDKMEMWRTRACK_H

#include "Wted.h"

#define CmdWtedZudkMemwrtrackGetInfo CtrWtedZudkMemwrtrack::CmdGetInfo

#define VecVWtedZudkMemwrtrackCapture CtrWtedZudkMemwrtrack::VecVCapture
#define VecVWtedZudkMemwrtrackCommand CtrWtedZudkMemwrtrack::VecVCommand
#define VecVWtedZudkMemwrtrackState CtrWtedZudkMemwrtrack::VecVState
#define VecVWtedZudkMemwrtrackTrigger CtrWtedZudkMemwrtrack::VecVTrigger

/**
	* CtrWtedZudkMemwrtrack
	*/
class CtrWtedZudkMemwrtrack : public CtrWted {

public:
	/**
		* VecVCapture (full: VecVWtedZudkMemwrtrackCapture)
		*/
	class VecVCapture {
	...
	/**
		* VecVCommand (full: VecVWtedZudkMemwrtrackCommand)
		*/
	class VecVCommand {
	...
	/**
		* VecVState (full: VecVWtedZudkMemwrtrackState)
		*/
	class VecVState {
	...
	/**
		* VecVTrigger (full: VecVWtedZudkMemwrtrackTrigger)
		*/
	class VecVTrigger {
...
public:
	CtrWtedZudkMemwrtrack(UntWted* unt);
	~CtrWtedZudkMemwrtrack();
