/**
	* \file UntWtedTidk_vecs.h
	* Efinix Titanium Ti180 development kit unit vectors (declarations)
...
#ifndef UNTWTEDTIDK_VECS_H
#define UNTWTEDTIDK_VECS_H
...
namespace VecVWtedTidkBuffer {
	...
	constexpr uint8_t CNTBUFMFSMTRACK1TOHOSTIF = 0x02;
	constexpr uint8_t CNTBUFMFSMTRACK0TOHOSTIF = 0x03;
	...
	constexpr uint8_t SEQBUFMEMWRTRACKTOHOSTIF = 0x08;
	constexpr uint8_t SEQBUFMEMRDTRACKTOHOSTIF = 0x09;
	constexpr uint8_t SEQBUFMFSMTRACK0TOHOSTIF = 0x0A;
